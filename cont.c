...
static void __fastcall contupdate_nothing(int port) { ; } /* nothing */
...
/* nothing */
static u8 __fastcall contread_nothing(int port) { return 0x3f; }
static void __fastcall contwrite_nothing(int port,u8 v) { ; }
...
/* magic key */
static u8 __fastcall contread_magickey(int port) { return 0x3c; }
...
/* nothing */
static void __fastcall contnf_nothing(int port) { ; }
