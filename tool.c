...
void tool_set_window(UINT window_id,UINT menu_id)
{
	...
	/* open */
		...
		switch (window_id) {
			case TOOL_WINDOW_TILEVIEW: tool_window[window_id]=CreateDialog(MAIN->module,MAKEINTRESOURCE(IDD_TILEVIEW),MAIN->window,tileview_window); break;
			case TOOL_WINDOW_SPRITEVIEW: tool_window[window_id]=CreateDialog(MAIN->module,MAKEINTRESOURCE(IDD_SPRITEVIEW),MAIN->window,spriteview_window); break;
			case TOOL_WINDOW_PSGTOY: tool_window[window_id]=CreateDialog(MAIN->module,MAKEINTRESOURCE(IDD_PSGTOY),MAIN->window,psgtoy_window); break;
