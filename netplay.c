...
#define DLL_FILE		"kailleraclient.dll"
...
int __fastcall netplay_is_active(void) { return (netplay.dialog|netplay.playing)&netplay_init_done; }
int netplay_keyboard_enabled(void) { return netplay.keyboard_enabled; }
